...
public class AppTests extends TestBase {
    ...
    @DisplayName("hi!!")
    void generatedTest() {
        step("open https://www.blue-storm.co.uk", () -> {
    ...
    void titleTest() {
        step("Open url 'https://www.blue-storm.co.uk'", () ->
            open("https://www.blue-storm.co.uk"));

        step("Page title should have text 'Blue Storm'", () -> {
            String expectedTitle = "Blue Storm";
